...
const { HarmonyError, defaultHarmonyConfigPath, discoverHdcCandidates, readHarmonyConfig, resolveHdcPath, writeHarmonyConfig } = await jiti.import("./harmony/index.ts");
