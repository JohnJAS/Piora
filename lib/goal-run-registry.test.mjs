...
test("target mode distinguishes a user decision from an external blocker", async () => {
...
test("a paused goal survives prompt cleanup and rebinds to the next target-mode run", async () => {
