...
test("the original Piora mark is configured for Windows and web app surfaces", () => {
  ...
  assert.match(provenance, /does not reuse the Pi, Codex, OpenAI/i);
  assert.match(provenance, /piora-icon\.svg/);
  assert.match(read("desktop/build/piora-icon.svg").toString("utf8"), /id="pi"/);
