export const replySuggestionsZh: Record<string, string> = {
  ...
  "reply.error.model_unavailable": "提取模型不可用，请重新选择或登录提供商。", "reply.error.invalid_settings": "提取设置不完整，请选择模型并保存提示词。", "reply.error.timeout": "提取超时，可以稍后重试。", "reply.error.invalid_output": "无法读取模型返回的选项格式。", "reply.error.provider_error": "提取模型请求失败，请检查提供商连接。", "reply.error.network_error": "网络请求失败，请稍后重试。", "reply.error.busy": "提取请求较多，请稍后重试。",
};
