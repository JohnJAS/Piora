export const replySuggestionsZh: Record<string, string> = {
  ...
  "reply.preview": "测试提取", "reply.sample": "示例助手回复", "reply.test": "开始测试", "reply.previewHelp": "使用尚未保存的模型和提示词测试；此处输入不会发送到会话。",
  ...
  "reply.error.model_unavailable": "提取模型不可用，请重新选择或登录提供商。", "reply.error.invalid_settings": "提取设置不完整，请选择模型并保存提示词。", "reply.error.timeout": "提取模型在 60 秒内未返回结果。可重试，或在快捷回复设置中选择响应更快的模型。", "reply.error.invalid_output": "无法读取模型返回的选项格式。", "reply.error.provider_error": "提取模型请求失败，请检查提供商连接。", "reply.error.network_error": "网络请求失败，请稍后重试。", "reply.error.busy": "提取请求较多，请稍后重试。",
};
export const replySuggestionsEn: Record<string, string> = {
  ...
  "reply.preview": "Test extraction", "reply.sample": "Sample assistant reply", "reply.test": "Run test", "reply.previewHelp": "Tests your unsaved model and prompt. This draft is never sent to a conversation.",
  ...
  "reply.error.model_unavailable": "The extraction model is unavailable. Choose another or sign in.", "reply.error.invalid_settings": "Choose an extraction model and save a valid prompt.", "reply.error.timeout": "The extraction model did not respond within 60 seconds. Retry or choose a faster model in Quick replies settings.", "reply.error.invalid_output": "Could not read the model’s reply format.", "reply.error.provider_error": "The extraction model request failed. Check the provider connection.", "reply.error.network_error": "The network request failed. Try again later.", "reply.error.busy": "Too many extraction requests. Try again later.",
};
