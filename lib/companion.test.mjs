...
test("companion preferences v3 preserves useful settings and removes legacy care state", () => {
  ...
  assert.equal(store.normalizeCompanionPreferences({ version: 4, open: true }, fallback), fallback);
});
