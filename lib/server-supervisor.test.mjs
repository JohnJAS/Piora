...
test("passes the staged runtime root to the web process for core extension discovery", () => {
  assert.match(source, /runtimeRoot: string/);
  assert.match(source, /PIORA_WEB_RUNTIME_ROOT: this\.options\.runtimeRoot/);
});
