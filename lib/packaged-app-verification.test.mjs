...
test("packaged runtime stages Piora core sources and reports tool status without requiring load success", async () => {
  ...
  assert.match(verifier, /\["browser", "harmony_device"\]/);
  assert.doesNotMatch(verifier, /Piora core extension tool is loaded but inactive/);
