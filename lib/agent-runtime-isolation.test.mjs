...
test("ordinary sessions load the first-party Harmony tool alongside coding extensions", () => {
  assert.match(rpc, /additionalExtensionPaths: \[bundledBrowserExtension, bundledHarmonyExtension, bundledGoalExtension\]/);
});
