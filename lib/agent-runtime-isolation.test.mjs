...
test("device-control constructs an allow-listed resource loader and tool registry", () => {
  ...
  assert.match(rpc, /additionalExtensionPaths: \[bundledHarmonyExtension\]/);
  ...
  assert.match(rpc, /loadedPaths\.length !== 1/);
...
test("standalone staging includes the first-party Harmony extension", () => {
