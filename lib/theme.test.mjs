...
test("offers a wallpaper-free Codex look alongside all twenty one-click artwork looks", () => {
...
test("keeps small text and links readable on every light visual look", () => {
  ...
  for (const theme of ["starlight", "ivory", "doodle", "fortune", "nordic", "sakura", "kitty", "cloud-bear"]) {
