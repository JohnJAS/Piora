...
No OpenPets executable, Swift source file, logo, spritesheet, or other visual
asset is bundled by Piora. The implementation was rewritten for Piora's
Electron/React runtime. The upstream MIT license is reproduced in this folder
and is included in packaged desktop distributions.
