...
Lockfile SHA-256: `59c12d42efc942d84564c3cb4cc38c8bd4f1046680a16bfef762beff00b255a1`
...
| `@aws-sdk/core` | `3.977.3` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-env` | `3.972.37` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-env` | `3.972.64` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-http` | `3.972.39` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-http` | `3.972.66` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-ini` | `3.972.41` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-ini` | `3.973.9` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-login` | `3.972.41` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-login` | `3.972.71` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-node` | `3.972.42` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-node` | `3.972.75` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-process` | `3.972.37` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-process` | `3.972.64` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-sso` | `3.972.41` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-sso` | `3.973.8` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-web-identity` | `3.972.41` | Apache-2.0 | No |
| `@aws-sdk/credential-provider-web-identity` | `3.972.70` | Apache-2.0 | No |
| `@aws-sdk/eventstream-handler-node` | `3.972.16` | Apache-2.0 | No |
| `@aws-sdk/eventstream-handler-node` | `3.972.31` | Apache-2.0 | No |
| `@aws-sdk/middleware-eventstream` | `3.972.12` | Apache-2.0 | No |
| `@aws-sdk/middleware-eventstream` | `3.972.26` | Apache-2.0 | No |
| `@aws-sdk/middleware-websocket` | `3.972.19` | Apache-2.0 | No |
| `@aws-sdk/middleware-websocket` | `3.972.46` | Apache-2.0 | No |
| `@aws-sdk/nested-clients` | `3.997.38` | Apache-2.0 | No |
| `@aws-sdk/nested-clients` | `3.997.9` | Apache-2.0 | No |
| `@aws-sdk/signature-v4-multi-region` | `3.996.27` | Apache-2.0 | No |
| `@aws-sdk/signature-v4-multi-region` | `3.996.43` | Apache-2.0 | No |
| `@aws-sdk/token-providers` | `3.1048.0` | Apache-2.0 | No |
| `@aws-sdk/token-providers` | `3.1098.0` | Apache-2.0 | No |
| `@aws-sdk/types` | `3.973.8` | Apache-2.0 | No |
| `@aws-sdk/types` | `3.974.2` | Apache-2.0 | No |
| `@aws-sdk/util-locate-window` | `3.965.5` | Apache-2.0 | No |
| `@aws-sdk/util-locate-window` | `3.965.8` | Apache-2.0 | No |
| `@aws-sdk/xml-builder` | `3.972.24` | Apache-2.0 | No |
| `@aws-sdk/xml-builder` | `3.972.37` | Apache-2.0 | No |
...
| `@earendil-works/pi-agent-core` | `0.83.0` | MIT | No |
| `@earendil-works/pi-ai` | `0.83.0` | MIT | No |
| `@earendil-works/pi-coding-agent` | `0.83.0` | MIT | No |
| `@earendil-works/pi-tui` | `0.83.0` | MIT | No |
...
| `@next/swc-darwin-arm64` | `16.2.12` | MIT | Yes |
| `@next/swc-darwin-x64` | `16.2.12` | MIT | Yes |
| `@next/swc-linux-arm64-gnu` | `16.2.12` | MIT | Yes |
| `@next/swc-linux-arm64-musl` | `16.2.12` | MIT | Yes |
| `@next/swc-linux-x64-gnu` | `16.2.12` | MIT | Yes |
| `@next/swc-linux-x64-musl` | `16.2.12` | MIT | Yes |
| `@next/swc-win32-arm64-msvc` | `16.2.12` | MIT | Yes |
| `@next/swc-win32-x64-msvc` | `16.2.12` | MIT | Yes |
...
| `mammoth` | `1.12.0` | BSD-2-Clause | No |
...
| `@emnapi/core` | `1.8.1` | MIT | Yes |
| `@emnapi/core` | `1.9.1` | MIT | Yes |
| `@emnapi/runtime` | `1.8.1` | MIT | Yes |
| `@emnapi/wasi-threads` | `1.1.0` | MIT | Yes |
...
| `@eslint/eslintrc` | `3.3.5` | MIT | No |
| `@eslint/js` | `9.39.4` | MIT | No |
...
| `@napi-rs/wasm-runtime` | `1.1.1` | MIT | Yes |
...
| `@tailwindcss/node` | `4.2.2` | MIT | No |
| `@tailwindcss/oxide` | `4.2.2` | MIT | No |
| `@tailwindcss/oxide-android-arm64` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-darwin-arm64` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-darwin-x64` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-freebsd-x64` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-linux-arm-gnueabihf` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-linux-arm64-gnu` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-linux-arm64-musl` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-linux-x64-gnu` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-linux-x64-musl` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-wasm32-wasi` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-win32-arm64-msvc` | `4.2.2` | MIT | Yes |
| `@tailwindcss/oxide-win32-x64-msvc` | `4.2.2` | MIT | Yes |
| `@tailwindcss/postcss` | `4.2.2` | MIT | No |
...
| `enhanced-resolve` | `5.20.1` | MIT | No |
...
| `eslint-plugin-react-hooks` | `7.0.1` | MIT | No |
...
| `tailwindcss` | `4.2.2` | MIT | No |
| `tapable` | `2.3.0` | MIT | No |
