...
本文对应源码版本 `0.5.1`。可下载版本以 [GitHub Releases](https://github.com/kexijiang/Piora/releases) 为准。

桌面端可在“设置 > 通用 > 运行日志”查看实际日志文件路径、复制路径或打开所在文件夹。此版本同时提供 Piora 与 XiaoYiHarness 品牌的 Windows 安装版、便携版、ZIP 和 Linux AppImage，XiaoYiHarness 使用新的名称与“交织 H”图标。
